  ...
  return (
    <div className="bg-E7E7DC px-10 py-20">
      <div className="gap-10 px-32">
        <div className="flex justify-center gap-20 text-455A64 border-t-[0.5px] pt-5 border-b-[0.5px] pb-5 border-CFD8DC">
          <ul className="border-l-[0.5px] border-CFD8DC pl-3">
          ...
          <ul className="border-r-[0.5px] border-CFD8DC pr-3">
